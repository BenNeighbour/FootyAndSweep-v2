...
export enum ActionType {
    ...
    /* Buy Sweepstake */
    GET_PROFILE_INFO_REQUEST = 'action/GET_PROFILE_INFO_REQUEST',
    GET_PROFILE_INFO_SUCCESS = 'action/GET_PROFILE_INFO_SUCCESS',
    GET_PROFILE_INFO_ERROR = 'action/GET_PROFILE_INFO_ERROR',
}
