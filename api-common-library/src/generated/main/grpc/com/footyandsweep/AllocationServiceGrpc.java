...
public final class AllocationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake, com.google.protobuf.Empty>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getAllocateSweepstakeMethod = AllocationServiceGrpc.getAllocateSweepstakeMethod) == null) {
      synchronized (AllocationServiceGrpc.class) {
        if ((getAllocateSweepstakeMethod = AllocationServiceGrpc.getAllocateSweepstakeMethod)
            == null) {
          AllocationServiceGrpc.getAllocateSweepstakeMethod =
              getAllocateSweepstakeMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new AllocationServiceMethodDescriptorSupplier("allocateSweepstake"))
                      .build();
        }
      }
    }
   ...
   */
  public static AllocationServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new AllocationServiceBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static AllocationServiceFutureStub newFutureStub(io.grpc.Channel channel) {
  ...
  /** */
  public abstract static class AllocationServiceImplBase implements io.grpc.BindableService {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
              ...
              asyncUnaryCall(
                  new MethodHandlers<
                      com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake,
                      com.google.protobuf.Empty>(this, METHODID_ALLOCATE_SWEEPSTAKE)))
          .build();
    }
  }

  /** */
  public static final class AllocationServiceStub
      extends io.grpc.stub.AbstractStub<AllocationServiceStub> {
    private AllocationServiceStub(io.grpc.Channel channel) {
      super(channel);
    }

    private AllocationServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void allocateSweepstake(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getAllocateSweepstakeMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  /** */
  public static final class AllocationServiceBlockingStub
      extends io.grpc.stub.AbstractStub<AllocationServiceBlockingStub> {
    ...
    /** */
    public com.google.protobuf.Empty allocateSweepstake(
        com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake request) {
  ...
  /** */
  public static final class AllocationServiceFutureStub
      extends io.grpc.stub.AbstractStub<AllocationServiceFutureStub> {
    private AllocationServiceFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private AllocationServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        allocateSweepstake(com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ALLOCATE_SWEEPSTAKE:
          serviceImpl.allocateSweepstake(
              (com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
  ...
  private abstract static class AllocationServiceBaseDescriptorSupplier
