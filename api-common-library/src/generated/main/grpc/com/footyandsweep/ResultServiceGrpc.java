...
public final class ResultServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty, com.google.protobuf.Empty>
      getCheckForSweepstakeResultsMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, com.google.protobuf.Empty>
        getCheckForSweepstakeResultsMethod;
    if ((getCheckForSweepstakeResultsMethod = ResultServiceGrpc.getCheckForSweepstakeResultsMethod)
        == null) {
      synchronized (ResultServiceGrpc.class) {
        if ((getCheckForSweepstakeResultsMethod =
                ResultServiceGrpc.getCheckForSweepstakeResultsMethod)
            == null) {
          ResultServiceGrpc.getCheckForSweepstakeResultsMethod =
              getCheckForSweepstakeResultsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.protobuf.Empty, com.google.protobuf.Empty>newBuilder()
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.protobuf.Empty.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new ResultServiceMethodDescriptorSupplier("checkForSweepstakeResults"))
                      .build();
        }
      }
    }
   ...
   */
  public static ResultServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new ResultServiceBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static ResultServiceFutureStub newFutureStub(io.grpc.Channel channel) {
  ...
  /** */
  public abstract static class ResultServiceImplBase implements io.grpc.BindableService {

    /** */
    public void checkForSweepstakeResults(
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
              getCheckForSweepstakeResultsMethod(),
              asyncUnaryCall(
                  new MethodHandlers<com.google.protobuf.Empty, com.google.protobuf.Empty>(
  ...
  public static final class ResultServiceStub extends io.grpc.stub.AbstractStub<ResultServiceStub> {
    ...
    private ResultServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ResultServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void checkForSweepstakeResults(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getCheckForSweepstakeResultsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  /** */
  public static final class ResultServiceBlockingStub
      extends io.grpc.stub.AbstractStub<ResultServiceBlockingStub> {
    private ResultServiceBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private ResultServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
  ...
  /** */
  public static final class ResultServiceFutureStub
      extends io.grpc.stub.AbstractStub<ResultServiceFutureStub> {
    private ResultServiceFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private ResultServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        checkForSweepstakeResults(com.google.protobuf.Empty request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_FOR_SWEEPSTAKE_RESULTS:
          serviceImpl.checkForSweepstakeResults(
              (com.google.protobuf.Empty) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
  ...
  private abstract static class ResultServiceBaseDescriptorSupplier
