...
public final class TicketServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.footyandsweep.Common.Id, com.footyandsweep.TicketServiceOuterClass.Ticket>
      getFindTicketByIdMethod;
  private static volatile io.grpc.MethodDescriptor<
          com.footyandsweep.Common.Id, com.footyandsweep.TicketServiceOuterClass.TicketList>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getFindTicketByIdMethod = TicketServiceGrpc.getFindTicketByIdMethod) == null) {
      synchronized (TicketServiceGrpc.class) {
        if ((getFindTicketByIdMethod = TicketServiceGrpc.getFindTicketByIdMethod) == null) {
          TicketServiceGrpc.getFindTicketByIdMethod =
              getFindTicketByIdMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.footyandsweep.TicketServiceOuterClass.Ticket
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new TicketServiceMethodDescriptorSupplier("findTicketById"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            com.footyandsweep.Common.Id, com.footyandsweep.TicketServiceOuterClass.TicketList>
        getGetAllTicketsBySweepstakeIdMethod;
    if ((getGetAllTicketsBySweepstakeIdMethod =
            TicketServiceGrpc.getGetAllTicketsBySweepstakeIdMethod)
        == null) {
      synchronized (TicketServiceGrpc.class) {
        if ((getGetAllTicketsBySweepstakeIdMethod =
                TicketServiceGrpc.getGetAllTicketsBySweepstakeIdMethod)
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.footyandsweep.TicketServiceOuterClass.TicketList
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new TicketServiceMethodDescriptorSupplier("getAllTicketsBySweepstakeId"))
                      .build();
        }
      }
    }
   ...
   */
  public static TicketServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new TicketServiceBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static TicketServiceFutureStub newFutureStub(io.grpc.Channel channel) {
  ...
  /** */
  public abstract static class TicketServiceImplBase implements io.grpc.BindableService {

    /** */
    public void findTicketById(
        com.footyandsweep.Common.Id request,
        io.grpc.stub.StreamObserver<com.footyandsweep.TicketServiceOuterClass.Ticket>
            responseObserver) {
    ...
    public void getAllTicketsBySweepstakeId(
        com.footyandsweep.Common.Id request,
        io.grpc.stub.StreamObserver<com.footyandsweep.TicketServiceOuterClass.TicketList>
            responseObserver) {
  ...
  public static final class TicketServiceStub extends io.grpc.stub.AbstractStub<TicketServiceStub> {
    ...
    private TicketServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected TicketServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void findTicketById(
        ...
        io.grpc.stub.StreamObserver<com.footyandsweep.TicketServiceOuterClass.Ticket>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getFindTicketByIdMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void getAllTicketsBySweepstakeId(
        ...
        io.grpc.stub.StreamObserver<com.footyandsweep.TicketServiceOuterClass.TicketList>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetAllTicketsBySweepstakeIdMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class TicketServiceBlockingStub
      extends io.grpc.stub.AbstractStub<TicketServiceBlockingStub> {
    private TicketServiceBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private TicketServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    /** */
    public com.footyandsweep.TicketServiceOuterClass.Ticket findTicketById(
        com.footyandsweep.Common.Id request) {
      return blockingUnaryCall(getChannel(), getFindTicketByIdMethod(), getCallOptions(), request);
    }

    /** */
    public com.footyandsweep.TicketServiceOuterClass.TicketList getAllTicketsBySweepstakeId(
        com.footyandsweep.Common.Id request) {
  ...
  public static final class TicketServiceFutureStub
      extends io.grpc.stub.AbstractStub<TicketServiceFutureStub> {
    private TicketServiceFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private TicketServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.footyandsweep.TicketServiceOuterClass.Ticket>
        findTicketById(com.footyandsweep.Common.Id request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.footyandsweep.TicketServiceOuterClass.TicketList>
        getAllTicketsBySweepstakeId(com.footyandsweep.Common.Id request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FIND_TICKET_BY_ID:
          serviceImpl.findTicketById(
              (com.footyandsweep.Common.Id) request,
              (io.grpc.stub.StreamObserver<com.footyandsweep.TicketServiceOuterClass.Ticket>)
                  responseObserver);
          break;
        case METHODID_GET_ALL_TICKETS_BY_SWEEPSTAKE_ID:
          serviceImpl.getAllTicketsBySweepstakeId(
              (com.footyandsweep.Common.Id) request,
              (io.grpc.stub.StreamObserver<com.footyandsweep.TicketServiceOuterClass.TicketList>)
                  responseObserver);
          break;
  ...
  private abstract static class TicketServiceBaseDescriptorSupplier
