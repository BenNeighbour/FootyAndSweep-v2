...
public final class SweepstakeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.footyandsweep.Common.Id, com.footyandsweep.SweepstakeServiceOuterClass.SweepstakeList>
      getFindSweepstakeByFootballMatchIdMethod;
  private static volatile io.grpc.MethodDescriptor<
          com.footyandsweep.Common.Id, com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake>
      getFindSweepstakeByIdMethod;
  private static volatile io.grpc.MethodDescriptor<
          com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake, com.footyandsweep.Common.Map>
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.footyandsweep.Common.Id, com.footyandsweep.Common.Ids>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
        ...
        getFindSweepstakeByFootballMatchIdMethod;
    if ((getFindSweepstakeByFootballMatchIdMethod =
            SweepstakeServiceGrpc.getFindSweepstakeByFootballMatchIdMethod)
        == null) {
      synchronized (SweepstakeServiceGrpc.class) {
        if ((getFindSweepstakeByFootballMatchIdMethod =
                SweepstakeServiceGrpc.getFindSweepstakeByFootballMatchIdMethod)
          ...
          SweepstakeServiceGrpc.getFindSweepstakeByFootballMatchIdMethod =
              getFindSweepstakeByFootballMatchIdMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(
                          generateFullMethodName(
                              "com.footyandsweep.SweepstakeService",
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.footyandsweep.SweepstakeServiceOuterClass.SweepstakeList
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SweepstakeServiceMethodDescriptorSupplier(
                              "findSweepstakeByFootballMatchId"))
                      .build();
        }
      }
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.footyandsweep.Common.Id, com.footyandsweep.Common.Ids>
      getGetAllSweepstakeParticipantsMethod() {
    io.grpc.MethodDescriptor<com.footyandsweep.Common.Id, com.footyandsweep.Common.Ids>
        getGetAllSweepstakeParticipantsMethod;
    if ((getGetAllSweepstakeParticipantsMethod =
            SweepstakeServiceGrpc.getGetAllSweepstakeParticipantsMethod)
        == null) {
      synchronized (SweepstakeServiceGrpc.class) {
        if ((getGetAllSweepstakeParticipantsMethod =
                SweepstakeServiceGrpc.getGetAllSweepstakeParticipantsMethod)
          ...
          SweepstakeServiceGrpc.getGetAllSweepstakeParticipantsMethod =
              getGetAllSweepstakeParticipantsMethod =
                  io.grpc.MethodDescriptor
                      .<com.footyandsweep.Common.Id, com.footyandsweep.Common.Ids>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(
                              "com.footyandsweep.SweepstakeService",
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getResultHelperMethod = SweepstakeServiceGrpc.getResultHelperMethod) == null) {
      synchronized (SweepstakeServiceGrpc.class) {
        if ((getResultHelperMethod = SweepstakeServiceGrpc.getResultHelperMethod) == null) {
          SweepstakeServiceGrpc.getResultHelperMethod =
              getResultHelperMethod =
                  io.grpc.MethodDescriptor
                      .<com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake,
                          com.footyandsweep.SweepstakeServiceOuterClass.PairList>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.footyandsweep.SweepstakeServiceOuterClass.PairList
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SweepstakeServiceMethodDescriptorSupplier("resultHelper"))
                      .build();
        }
      }
    }
  ...
  public abstract static class SweepstakeServiceImplBase implements io.grpc.BindableService {
    ...
    public void findSweepstakeByFootballMatchId(
        ...
        io.grpc.stub.StreamObserver<com.footyandsweep.SweepstakeServiceOuterClass.SweepstakeList>
            responseObserver) {
    ...
    public void resultHelper(
        com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake request,
        io.grpc.stub.StreamObserver<com.footyandsweep.SweepstakeServiceOuterClass.PairList>
            responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
              ...
              asyncUnaryCall(
                  new MethodHandlers<
                      com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake,
                      com.footyandsweep.Common.Map>(this, METHODID_GET_RESULT_HELPER_MAP)))
          .addMethod(
              getRequestNewSweepstakeMethod(),
              asyncUnaryCall(
                  new MethodHandlers<
          ...
          .addMethod(
              getGetAllSweepstakeParticipantsMethod(),
              asyncUnaryCall(
                  new MethodHandlers<com.footyandsweep.Common.Id, com.footyandsweep.Common.Ids>(
  ...
  public static final class SweepstakeServiceStub
    ...
    public void findSweepstakeByFootballMatchId(
        ...
        io.grpc.stub.StreamObserver<com.footyandsweep.SweepstakeServiceOuterClass.SweepstakeList>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getFindSweepstakeByFootballMatchIdMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void getAllSweepstakeParticipants(
        ...
        io.grpc.stub.StreamObserver<com.footyandsweep.Common.Ids> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetAllSweepstakeParticipantsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void resultHelper(
        ...
        io.grpc.stub.StreamObserver<com.footyandsweep.SweepstakeServiceOuterClass.PairList>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getResultHelperMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class SweepstakeServiceBlockingStub
    ...
    /** */
    public com.footyandsweep.SweepstakeServiceOuterClass.SweepstakeList
        findSweepstakeByFootballMatchId(com.footyandsweep.Common.Id request) {
      return blockingUnaryCall(
    ...
    /** */
    public com.footyandsweep.Common.Map getResultHelperMap(
        com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake request) {
      return blockingUnaryCall(
    ...
    /** */
    public com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake requestNewSweepstake(
        com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake request) {
      return blockingUnaryCall(
    ...
    /** */
    public com.footyandsweep.Common.Ids getAllSweepstakeParticipants(
        com.footyandsweep.Common.Id request) {
      return blockingUnaryCall(
    ...
    /** */
    public com.footyandsweep.SweepstakeServiceOuterClass.PairList resultHelper(
        com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake request) {
      return blockingUnaryCall(getChannel(), getResultHelperMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class SweepstakeServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake>
        findSweepstakeById(com.footyandsweep.Common.Id request) {
      return futureUnaryCall(
          getChannel().newCall(getFindSweepstakeByIdMethod(), getCallOptions()), request);
    }

    /** */
    public com.google.common.util.concurrent.ListenableFuture<com.footyandsweep.Common.Map>
    ...
    /** */
    public com.google.common.util.concurrent.ListenableFuture<com.footyandsweep.Common.Ids>
        getAllSweepstakeParticipants(com.footyandsweep.Common.Id request) {
      return futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.footyandsweep.SweepstakeServiceOuterClass.PairList>
        resultHelper(com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_FIND_SWEEPSTAKE_BY_FOOTBALL_MATCH_ID:
          serviceImpl.findSweepstakeByFootballMatchId(
              (com.footyandsweep.Common.Id) request,
              (io.grpc.stub.StreamObserver<
                      com.footyandsweep.SweepstakeServiceOuterClass.SweepstakeList>)
                  responseObserver);
        ...
        case METHODID_GET_ALL_SWEEPSTAKE_PARTICIPANTS:
          serviceImpl.getAllSweepstakeParticipants(
              (com.footyandsweep.Common.Id) request,
              (io.grpc.stub.StreamObserver<com.footyandsweep.Common.Ids>) responseObserver);
          break;
        case METHODID_RESULT_HELPER:
          serviceImpl.resultHelper(
              (com.footyandsweep.SweepstakeServiceOuterClass.Sweepstake) request,
              (io.grpc.stub.StreamObserver<com.footyandsweep.SweepstakeServiceOuterClass.PairList>)
                  responseObserver);
          break;
