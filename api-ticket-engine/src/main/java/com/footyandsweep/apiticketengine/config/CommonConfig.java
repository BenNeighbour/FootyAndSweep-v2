...
public class CommonConfig {
    ...
    @Bean
    public DomainEventDispatcher domainEventDispatcher(TicketEventSubscriber sweepstakeEventSubscriber, DomainEventDispatcherFactory domainEventDispatcherFactory) {
